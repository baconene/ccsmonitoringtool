...
<template>
    <Head title="Learning Management System - Welcome">
    ...
    >
        ...
        >
            ...
            >
                ...
                >
                    <h1 class="mb-4 text-2xl font-bold text-[#1b1b18] dark:text-[#EDEDEC]">Learning Management System</h1>
                    <p class="mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                        Empowering education through technology. <br />
                        Manage courses, track progress, and facilitate learning for students and instructors.
                    </p>
                    
                    <!-- For Instructors Section -->
                    <div class="mb-6">
                        <h2 class="mb-3 text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">For Instructors</h2>
                        <ul class="mb-4 flex flex-col space-y-3">
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#4ade80] dark:bg-[#22c55e]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Course Management</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Create, organize, and manage comprehensive courses with modules and lessons</p>
                                </div>
                            </li>
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#3b82f6] dark:bg-[#2563eb]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Student Progress Tracking</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Monitor student enrollment, lesson completion, and overall progress</p>
                                </div>
                            </li>
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#f59e0b] dark:bg-[#d97706]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Analytics Dashboard</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Access comprehensive analytics and insights about course performance</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="mb-6">
                        <h2 class="mb-3 text-lg font-semibold text-[#1b1b18] dark:text-[#EDEDEC]">For Students</h2>
                        <ul class="mb-4 flex flex-col space-y-3">
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#8b5cf6] dark:bg-[#7c3aed]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Course Enrollment</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Browse and enroll in available courses tailored to your learning goals</p>
                                </div>
                            </li>
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#ec4899] dark:bg-[#db2777]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Progress Tracking</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Track your learning progress with individual lesson completion markers</p>
                                </div>
                            </li>
                            <li class="relative flex items-start gap-4 py-1">
                                <span class="flex h-3.5 w-3.5 items-center justify-center rounded-full border border-[#e3e3e0] bg-[#FDFDFC] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.03),0px_1px_2px_0px_rgba(0,0,0,0.06)] dark:border-[#3E3E3A] dark:bg-[#161615] mt-1.5">
                                    <span class="h-1.5 w-1.5 rounded-full bg-[#06b6d4] dark:bg-[#0891b2]" />
                                </span>
                                <div>
                                    <span class="font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Interactive Learning</span>
                                    <p class="text-[#706f6c] dark:text-[#A1A09A] text-xs">Access structured lessons, modules, and activities in an intuitive interface</p>
                                </div>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 text-sm leading-normal">
                        <Link
                            v-if="$page.props.auth.user"
                            :href="'/dashboard'"
                            class="inline-block rounded-lg border border-[#4ade80] bg-[#22c55e] px-6 py-3 text-sm font-medium leading-normal text-white hover:bg-[#16a34a] transition-colors duration-200 text-center"
                        >
                            Go to Dashboard
                        </Link>
                        <template v-else>
                            <Link
                                :href="login()"
                                class="inline-block rounded-lg border border-[#3b82f6] bg-[#2563eb] px-6 py-3 text-sm font-medium leading-normal text-white hover:bg-[#1d4ed8] transition-colors duration-200 text-center"
                            >
                                Login to Start Learning
                            </Link>
                            <Link
                                :href="register()"
                                class="inline-block rounded-lg border border-[#6b7280] bg-transparent px-6 py-3 text-sm font-medium leading-normal text-[#1b1b18] hover:bg-[#f3f4f6] dark:text-[#EDEDEC] dark:border-[#4b5563] dark:hover:bg-[#374151] transition-colors duration-200 text-center"
                            >
                                Create Account
                            </Link>
                        </template>
