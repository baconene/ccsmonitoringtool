...
// Effective module completion used for badges and UI:
// treat a module as completed if either the backend has
// marked it completed OR all of its children are completed
// according to the same rules as canCompleteModule.
const isModuleCompleted = (module: any) => {
  if (!module) return false;
  return !!module.is_completed || canCompleteModule(module.id);
};
            ...
            <div class="flex items-start justify-between">
              <div class="flex-1">
                <div class="flex items-center gap-2">
                  ...
                  <Badge v-if="isModuleCompleted(module)" variant="outline" class="bg-green-50 dark:bg-green-900/20 text-green-700 dark:text-green-300 border-green-200 dark:border-green-800">
                ...
                <div class="mt-3 space-y-2">
                  ...
                  <div v-if="!isModuleCompleted(module) && !canCompleteModule(module.id)" class="flex items-start space-x-2 text-xs text-amber-700 dark:text-amber-300 bg-amber-50 dark:bg-amber-900/20 rounded-md p-2">
              ...
              <div class="ml-4 flex flex-col gap-2">
                ...
                <div v-if="!isModuleCompleted(module) && !canCompleteModule(module.id)" class="text-xs text-amber-600 dark:text-amber-400 mt-1 max-w-48">
