<template>
    <div v-if="show" class="fixed inset-0 flex items-center justify-center bg-black/50 dark:bg-black/70 z-50 p-4">
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl p-6 w-full max-w-md border border-gray-200 dark:border-gray-700">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-bold text-gray-900 dark:text-gray-100 mb-2">Delete Question</h3>
                    <p class="text-sm text-gray-600 dark:text-gray-300 mb-1">
                        Are you sure you want to delete this question?
                    </p>
                    <p v-if="questionText" class="text-sm text-gray-700 dark:text-gray-400 italic mb-2 line-clamp-2">
                        "{{ questionText }}"
                    </p>
