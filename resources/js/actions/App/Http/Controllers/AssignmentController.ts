 ...
 * @see app/Http/Controllers/AssignmentController.php:23
 * @route '/assignments'
 */
 ...
 * @see app/Http/Controllers/AssignmentController.php:84
 * @route '/assignments'
 */
 ...
 * @see app/Http/Controllers/AssignmentController.php:256
 * @route '/assignments/{assignment}'
 */
 ...
 * @see app/Http/Controllers/AssignmentController.php:415
 * @route '/assignments/{assignment}'
 */
...
const AssignmentController = { index, create, store, show, edit, update, destroy }
